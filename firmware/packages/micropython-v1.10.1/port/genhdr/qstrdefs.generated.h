...
QDEF(MP_QSTR_http_ota, (const byte*)"\x58\x08" "http_ota")
QDEF(MP_QSTR_wifi_join, (const byte*)"\x09\x09" "wifi_join")
QDEF(MP_QSTR_player, (const byte*)"\xd6\x06" "player")
QDEF(MP_QSTR_opensong, (const byte*)"\xe4\x08" "opensong")
...
QDEF(MP_QSTR_recorder, (const byte*)"\x9f\x08" "recorder")
...
QDEF(MP_QSTR_server_start, (const byte*)"\x5f\x0c" "server_start")
QDEF(MP_QSTR_server_stop, (const byte*)"\x07\x0b" "server_stop")
// This file was automatically generated by makeqstrdata.py
