...
#define MICROPYTHON_USING_PLAYER
#define MICROPYTHON_USING_RECORDER
#define MICROPYTHON_USING_CAMERA
...
#define MICROPYTHON_USING_USSL
#define PKG_MICROPYTHON_HEAP_SIZE 102400
#define PKG_USING_MICROPYTHON_V11003
#define PKG_MICROPYTHON_VER_NUM 0x11003

/* multimedia packages */
#define PKG_USING_WAVPLAYER
#define PKG_WP_USING_RECORD
#define PKG_WP_RECORD_DEVICE "mic"
